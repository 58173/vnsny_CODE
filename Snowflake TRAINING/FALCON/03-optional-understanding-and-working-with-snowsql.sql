...
-- 3.2.5   Create a FALCON_TBL if you hadn’t already in FALCON_DB. You may
...
CREATE OR REPLACE TABLE FALCON_DB.PUBLIC.FALCON_TBL (
  id NUMBER(38,0),
  name STRING(10),
  country VARCHAR(20),
  order_date DATE
...
INSERT INTO FALCON_TBL VALUES(2, 'A','UK', '11/02/2005');
INSERT INTO FALCON_TBL VALUES(4, 'C','SP', '11/02/2005');
INSERT INTO FALCON_TBL VALUES(3, 'C','DE', '11/02/2005');


-- 3.2.7   Insert several more rows using a single INSERT INTO statement:

INSERT INTO FALCON_TBL VALUES
    (1, 'ORDERC007', 'JAPAN', '11/02/2005'),
    (7, 'ORDERF821', 'UK', '11/03/2005'),
    (12, 'ORDERB029', 'USA', '11/03/2005');


-- 3.2.8   Query the data in FALCON_TBL and order it by ID:

SELECT * FROM FALCON_TBL
ORDER BY id;
...
INSERT INTO FALCON_SCHEMA.members
VALUES
...
SELECT * FROM FALCON_SCHEMA.members;
...
snowsql -a [account] -u FALCON -f script.sql
