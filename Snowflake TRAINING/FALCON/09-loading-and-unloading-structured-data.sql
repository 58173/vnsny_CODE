...
-- 9.3.1   Empty the REGION Table in the PUBLIC schema of FALCON_DB:
...
--         FALCON_WH and click Next.

-- 9.4.11  You should see an option to load a file from your computer. Click the
...
-- 9.4.17  You should have ten rows in the REGION table now.
