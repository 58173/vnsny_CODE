...
-- 4.4.4   Put the cursor DIRECTLY after the * and type an M followed by a .:
...
-- 4.13.5  Select labels for both axes.

-- 4.13.6  Hover the cursor over various bars in the bar chart and observe that
--         the details for that data are shown.

-- 4.13.7  Try the follow changes to observe the results:
...
-- 4.17.5  Select a table from the list and look at the Details and the columns.
