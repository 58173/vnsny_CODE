...
-- 1.2.3   Name the database FALCON_DB.
...
-- 1.3.2   Click [Create] and create a table named FALCON_TBL.
...
DROP DATABASE FALCON_DB;

--         NOTE: This will drop any tables in the database, as well. You do not
--         need a warehouse to create objects.

-- 1.4.4   Drop your warehouse, and then recreate your database (FALCON_DB)
--         using SQL:

DROP WAREHOUSE FALCON_WH;
...
ALTER USER FALCON
    ...
    DEFAULT_NAMESPACE=FALCON_DB.PUBLIC
