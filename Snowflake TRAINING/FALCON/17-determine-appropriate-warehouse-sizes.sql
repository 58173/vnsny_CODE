...
ALTER WAREHOUSE FALCON_WH RESUME;
ALTER SESSION SET USE_CACHED_RESULT = FALSE;
ALTER SESSION SET QUERY_TAG = 'FALCON_WH_Sizing';
...
ALTER WAREHOUSE FALCON_WH SUSPEND;
ALTER WAREHOUSE FALCON_WH SET WAREHOUSE_SIZE = Medium;
ALTER WAREHOUSE FALCON_WH RESUME;
...
ALTER WAREHOUSE FALCON_WH SUSPEND;
ALTER WAREHOUSE FALCON_WH SET WAREHOUSE_SIZE = Large;
ALTER WAREHOUSE FALCON_WH RESUME;
...
ALTER WAREHOUSE FALCON_WH SUSPEND;
ALTER WAREHOUSE FALCON_WH SET WAREHOUSE_SIZE = XLarge;
ALTER WAREHOUSE FALCON_WH RESUME;
...
WHERE  query_tag = 'FALCON_WH_Sizing' 
